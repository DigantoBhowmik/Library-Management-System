...
{
    [DbContext(typeof(DigantoDbContext))]
    [Migration("20220914070714_add")]
    partial class add
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diganto.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Diganto.BookWithAuthors.BookWithAuthor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppbookWithAuthors");
                });

            modelBuilder.Entity("Diganto.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Diganto.Publishers.Publisher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Diganto.Authors.Author", b =>
                {
                    b.HasOne("Diganto.Books.Book", null)
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("Diganto.Books.Book", b =>
                {
                    b.HasOne("Diganto.Authors.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Diganto.Publishers.Publisher", null)
                        .WithMany()
